...
[assembly: ExportRenderer(typeof(Moments.Controls.RoundedRectangleImage), typeof(Moments.Droid.RoundedRectangleImageRenderer))]
namespace Moments.Droid
{
    [Preserve]
    public class RoundedRectangleImageRenderer : ImageRenderer
    {
        public RoundedRectangleImageRenderer(Context context) : base(context)
        {
        }
